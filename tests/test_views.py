...
def test_currency_rate(mock_get):
    ...
    mock_client.latest.return_value = {"data": {"RUB": {"value": 80.0}}}
    user_setting = {"user_currencies": ["USD", "RUB"]}
...
@pytest.mark.parametrize(
    ...
    [
        {
            "main": [
                {"amount": "-4877", "category": "Без информации"},
                {"amount": "-1509", "category": "Супермаркеты"},
